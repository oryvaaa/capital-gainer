        ...
        <div className="flex-1 overflow-hidden">
          ...
          >
            <span className="text-sm text-foreground/80">
              Investing and trading in securities markets involves risk. Capital Gainer (Research Analyst) does not guarantee returns . Always use proper risk management and stop-loss orders. Report suspicious activity to our official support line.
              {" "}&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;{" "}
              Investing and trading in securities markets involves risk. Capital Gainer (Research Analyst) does not guarantee returns . Always use proper risk management and stop-loss orders. Report suspicious activity to our official support line.
            </span>
          </div>
